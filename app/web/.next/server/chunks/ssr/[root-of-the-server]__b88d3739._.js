...
const mockStores = [
    {
        id: 'berwyn-il',
        name: 'Dollar Tree Berwyn',
        code: 'DT-BYW',
        active: true
    },
    {
        id: 'chicago-1',
        name: 'Dollar Tree Chicago West',
        code: 'DT-CHW',
        active: true
    }
];
...
const mockExpenses = [
    {
        ...
        amount: 12.50,
        description: 'Reabastecimiento semanal de suministros de limpieza',
        createdAt: new Date().getTime() - 86400000 * 1,
        attachmentUrl: 'https://picsum.photos/seed/receipt1/400/600',
        storeId: 'berwyn-il',
    ...
    },
    {
        ...
        item: 'Cambio de Bombilla',
        amount: 25.00,
        description: 'Reemplazo de bombilla parpadeante en pasillo 3',
    ...
    },
    {
        ...
        amount: 45.75,
        description: 'Caja de papel A4 para oficina',
        createdAt: new Date().getTime() - 86400000 * 3,
        attachmentUrl: 'https://picsum.photos/seed/receipt2/400/600',
        storeId: 'berwyn-il',
    ...
    },
    {
        id: 'exp-4',
        category: 'store_supplies',
        item: 'Rollos de Cinta de Registro',
        amount: 22.30,
        description: 'Pedido al por mayor de papel de recibos',
        createdAt: new Date().getTime() - 86400000 * 4,
        storeId: 'berwyn-il',
        date: new Date(Date.now() - 86400000 * 4).toISOString().split('T')[0]
    }
];
const mockDailyReports = Array.from({
    length: 7
}).map((_, i)=>{
    const date = new Date();
    ...
    return {
        ...
        anomalies: Math.random() > 0.7 ? [
            {
                type: 'Discrepancia de Efectivo',
                message: `Se detectó sobrante/faltante de efectivo de $${(Math.random() * 4 + 5).toFixed(2)}.`
            }
        ] : []
    };
});
...
function AuthProvider({ children }) {
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (email)=>{
        setLoading(true);
        // Mock authentication
        const foundUser = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockUsers"][email];
        if (foundUser) {
            setUser(foundUser);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b88d3739._.js.map